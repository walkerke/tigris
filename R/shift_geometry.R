...
#'
#' ggplot() +
#'   geom_sf(data = us_states_outside, color = "blue") +
#'   geom_sf(data = us_states_eqarea, color = "red") +
#'   geom_sf(data = us_states, fill = NA, color = "black", size = 0.1) +
#'   theme_void(base_size = 16) +
#'   labs(
#'      title = "Alaska, Hawaii, and Puerto Rico are shifted and not to scale."
#'   ) +
